...
describe('Slider', function () {
  ...
  describe('Swiping', function () {
    ...
    describe('onSwipeMove', function () {
      ...
      it('should not call setPosition if preventMovementUntilSwipeScrollTolerance is true and the tolerance has not been reached', function () {
        renderDefaultComponent({
      ...
      it('should call setPosition if preventMovementUntilSwipeScrollTolerance is true and movement has already begun', function () {
        renderDefaultComponent({
          swipeScrollTolerance: 10,
          preventMovementUntilSwipeScrollTolerance: true
        });
      ...
      it('should call setPosition if preventMovementUntilSwipeScrollTolerance is true and the tolerance has been reached', function () {
        renderDefaultComponent({
          swipeScrollTolerance: 10,
          preventMovementUntilSwipeScrollTolerance: true
        });
      ...
      it('should still call setPosition if preventMovementUntilSwipeScrollTolerance is false and the tolerance has not been reached', function () {
        renderDefaultComponent({
          swipeScrollTolerance: 10,
